...
def home_page():
    ...
    """, unsafe_allow_html=True)
    st.image("wordcloudd.png",  use_column_width=True)
...
def panduan():
    ...
    1. **Menu Labelisasi**:
       ...
       - Unggah File CSV: Unggah file CSV yang berisi teks berbahasa Indonesia dengan kolom teks bernama "judul".
       - Tombol Labelisasi: Klik tombol "Labelisasi" untuk memulai proses penerjemahan teks ke bahasa Inggris dan analisis sentimen.
       - Hasil Labelisasi: Setelah proses selesai, hasil labelisasi akan ditampilkan dalam bentuk tabel.
       - Untuk mengunduh data yang telah dilabelisasi, arahkan kursor ke tabel untuk melihat ikon unduh diatas tabel.
    
    2. **Menu Preprocessing Data**:
       - Gunakan Data yang Telah Diterjemahkan: Jika Anda telah melakukan labelisasi pada langkah sebelumnya, Anda dapat langsung menggunakan data tersebut.
       - Unggah File CSV: Jika belum, unggah file CSV yang telah dilabelisasi atau file baru yang ingin diproses.
       - Tombol Proses Data: Klik tombol "Processing Data" untuk memulai proses pembersihan teks, tokenisasi, penghapusan stopword, dan stemming.
       - Hasil Preprocessing: Setelah proses selesai, hasil preprocessing akan ditampilkan dalam bentuk tabel.
       - Untuk mengunduh data yang telah preprocessing, arahkan kursor ke tabel untuk melihat ikon unduh diatas tabel.
       
    3. **Menu Analisis Sentimen**:
       - Gunakan Data yang Telah Diproses: Jika Anda telah melakukan preprocessing pada langkah sebelumnya, Anda dapat langsung menggunakan data tersebut.
       - Unggah File CSV: Jika belum, unggah file CSV yang telah diproses atau file baru yang ingin dianalisis sentimennya.
       - Tombol Analisis Sentimen: Klik tombol "Analisis Sentimen" untuk memulai proses analisis sentimen menggunakan model IndoBERT.
       - Hasil Analisis Sentimen: Setelah proses selesai, hasil analisis sentimen akan ditampilkan dalam bentuk confuxion matrix dan classification report
...
with st.sidebar:
    ...
    selection = option_menu("SENTIMEN IndoBERT", ["Home", "Labelisasi", "Preprocessing Data", "Analisis Sentimen", "Panduan"], 
                            icons=['house', 'pencil-square', 'hourglass', 'bar-chart-line' ,'book'], menu_icon="cast", default_index=0)
    ...
    if uploaded_file_translate is not None:
        ...
        if st.button("Labelisasi"):
            if 'judul' in df_translate.columns:
                ...
                st.write("Data setelah labelisasi:")
...
# Preprocess Data Page
    ...
    if 'df_translated' in st.session_state and st.session_state.df_translated is not None:
        st.write("Menggunakan data yang sudah labelisasi sebelumnya.")
        st.write("Data yang sudah dilabelisasi:")
